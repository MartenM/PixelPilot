...
public enum PixelBlock : int
{
    ...
    HazardSpikesBrownLeft = 111,
    HazardSpikesBrownUp = 112,
    HazardSpikesBrownRight = 113,
    HazardSpikesBrownDown = 114,
    HazardSpikesBrownCenter = 115,
    HazardSpikesWhiteLeft = 116,
    HazardSpikesWhiteUp = 117,
    HazardSpikesWhiteRight = 118,
    HazardSpikesWhiteDown = 119,
    HazardSpikesWhiteCenter = 120,
    HazardSpikesGrayLeft = 121,
    HazardSpikesGrayUp = 122,
    HazardSpikesGrayRight = 123,
    HazardSpikesGrayDown = 124,
    HazardSpikesGrayCenter = 125,
    HazardSpikesRedLeft = 126,
    HazardSpikesRedUp = 127,
    HazardSpikesRedRight = 128,
    HazardSpikesRedDown = 129,
    HazardSpikesRedCenter = 130,
    HazardSpikesYellowLeft = 131,
    HazardSpikesYellowUp = 132,
    HazardSpikesYellowRight = 133,
    HazardSpikesYellowDown = 134,
    HazardSpikesYellowCenter = 135,
    HazardSpikesGreenLeft = 136,
    HazardSpikesGreenUp = 137,
    HazardSpikesGreenRight = 138,
    HazardSpikesGreenDown = 139,
    HazardSpikesGreenCenter = 140,
    HazardSpikesBlueLeft = 141,
    HazardSpikesBlueUp = 142,
    HazardSpikesBlueRight = 143,
    HazardSpikesBlueDown = 144,
